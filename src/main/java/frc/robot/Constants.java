   ...
   public static final class SwerveConstants {
    ...
    public static final class Mod0 {
            ...
            public static SwerveModuleConstants SwerveModuleConstants() {
                    return new SwerveModuleConstants(Ports.FrLf_DRIVE, Ports.FrLf_ROTATION, Ports.FrLf_CANCODER,
    ...
    public static final class Mod1 {
            ...
            public static SwerveModuleConstants SwerveModuleConstants() {
                    return new SwerveModuleConstants(Ports.FrRg_DRIVE, Ports.FrRg_ROTATION, Ports.FrRg_CANCODER,
                                    isComp ? compAngleOffset : betaAngleOffset);
            }
    }
    ...
    public static final class Mod2 {
            ...
            public static SwerveModuleConstants SwerveModuleConstants() {
                    return new SwerveModuleConstants(Ports.BcLf_DRIVE, Ports.BcLf_ROTATION, Ports.BcLf_CANCODER,
                                    isComp ? compAngleOffset : betaAngleOffset);
            }
    }
    ...
    public static final class Mod3 {
            ...
            public static SwerveModuleConstants SwerveModuleConstants() {
                    return new SwerveModuleConstants(Ports.BcRg_DRIVE, Ports.BcRg_ROTATION, Ports.BcRg_CANCODER,
                                    isComp ? compAngleOffset : betaAngleOffset);
            }
    }
